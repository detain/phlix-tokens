//#region src/tokens.generated.ts
var e = {
	base: {
		"--amber-50": "#fff8ec",
		"--amber-100": "#ffedcc",
		...
		"--shadow-2": "0 4px 14px rgba(0, 0, 0, 0.48)",
		"--shadow-3": "0 14px 36px rgba(0, 0, 0, 0.55)",
		"--shadow-4": "0 28px 64px -16px rgba(0, 0, 0, 0.72)",
		"--glow-amber": "0 0 0 1px rgba(245, 165, 36, 0.35), 0 10px 36px -8px rgba(245, 165, 36, 0.40)",
		"--shadow-xs": "0 1px 2px rgba(0, 0, 0, 0.45)",
		"--shadow-sm": "0 1px 2px rgba(0, 0, 0, 0.45)",
		"--shadow-md": "0 4px 14px rgba(0, 0, 0, 0.48)",
		"--shadow-lg": "0 14px 36px rgba(0, 0, 0, 0.55)",
		"--shadow-xl": "0 14px 36px rgba(0, 0, 0, 0.55)",
		"--shadow-2xl": "0 28px 64px -16px rgba(0, 0, 0, 0.72)",
		"--space-0": "0",
		"--space-1": "0.25rem",
		"--space-2": "0.5rem",
		"--space-3": "0.75rem",
		...
		"--text-md": "1.0625rem",
		"--text-lg": "1.25rem",
		"--text-xl": "clamp(1.4rem, 1.1rem + 1.2vw, 1.75rem)",
		"--text-2xl": "clamp(1.8rem, 1.3rem + 2vw, 2.5rem)",
		"--text-3xl": "clamp(2.4rem, 1.6rem + 3.2vw, 3.75rem)",
		"--text-4xl": "clamp(3rem, 1.9rem + 4.4vw, 4.5rem)",
		"--text-5xl": "clamp(3.5rem, 2rem + 6vw, 6rem)",
		"--text-hero": "clamp(3rem, 1.8rem + 5vw, 5.5rem)",
		"--font-normal": "400",
		"--fw-regular": "400",
		"--font-medium": "500",
		"--fw-medium": "500",
	...
	daylight: {
		...
		"--shadow-1": "0 1px 2px rgba(74, 55, 20, 0.10)",
		"--shadow-2": "0 4px 14px rgba(74, 55, 20, 0.12)",
		"--shadow-3": "0 14px 36px rgba(74, 55, 20, 0.16)",
		"--shadow-4": "0 28px 64px -16px rgba(74, 55, 20, 0.24)",
		"--glow-amber": "0 0 0 1px rgba(217, 130, 9, 0.30), 0 10px 36px -8px rgba(245, 165, 36, 0.35)",
		"--shadow-xs": "0 1px 2px rgba(74, 55, 20, 0.10)",
		"--shadow-sm": "0 1px 2px rgba(74, 55, 20, 0.10)",
		"--shadow-md": "0 4px 14px rgba(74, 55, 20, 0.12)",
		"--shadow-lg": "0 14px 36px rgba(74, 55, 20, 0.16)",
		"--shadow-xl": "0 14px 36px rgba(74, 55, 20, 0.16)",
		"--shadow-2xl": "0 28px 64px -16px rgba(74, 55, 20, 0.24)"
	},
	midnight: {
		"--accent": "#f5a524",
		"--accent-hover": "#fbab36",
		...
		"--shadow-1": "0 1px 2px rgba(0, 0, 0, 0.70)",
		"--shadow-2": "0 4px 14px rgba(0, 0, 0, 0.70)",
		"--shadow-3": "0 14px 36px rgba(0, 0, 0, 0.80)",
		"--shadow-4": "0 28px 64px -16px rgba(0, 0, 0, 0.90)",
		"--glow-amber": "0 0 0 1px rgba(245, 165, 36, 0.40), 0 10px 36px -8px rgba(245, 165, 36, 0.45)",
		"--shadow-xs": "0 1px 2px rgba(0, 0, 0, 0.70)",
		"--shadow-sm": "0 1px 2px rgba(0, 0, 0, 0.70)",
		"--shadow-md": "0 4px 14px rgba(0, 0, 0, 0.70)",
		"--shadow-lg": "0 14px 36px rgba(0, 0, 0, 0.80)",
		"--shadow-xl": "0 14px 36px rgba(0, 0, 0, 0.80)",
		"--shadow-2xl": "0 28px 64px -16px rgba(0, 0, 0, 0.90)"
	},
	spacing: {
		"--space-0": "0",
		"--space-1": "0.25rem",
...
var i = (e) => Math.max(0, Math.min(255, Math.round(e))), a = ({ r: e, g: t, b: n }) => "#" + [
	e,
	t,
	n
].map((e) => i(e).toString(16).padStart(2, "0")).join("");
function o(e, t) {
	return {
		r: e.r + (255 - e.r) * t,
		g: e.g + (255 - e.g) * t,
...
var c = ({ r: e, g: t, b: n }, r) => `rgba(${i(e)}, ${i(t)}, ${i(n)}, ${r})`;
